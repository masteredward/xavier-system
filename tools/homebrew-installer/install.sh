...
docker run --rm -it -v /opt/xavier/homebrew:/home/linuxbrew homebrew-installer
cp -f /opt/xavier/system/tools/homebrew-installer/homebrew.zsh /opt/xavier/root/.oh-my-zsh/custom/homebrew.zsh
cp -f /opt/xavier/system/tools/homebrew-installer/homebrew_bash /opt/xavier/homebrew/.bash_profile
chown 1000:1000 /opt/xavier/homebrew/.bash_profile